...
import { View, KeyboardAvoidingView, Image, RefreshControl, Alert, Dimensions, Platform } from 'react-native';
                                            ...
                                            renderItem={({item}) => (
                                                <View>
                                                    ...
                                                    <KeyboardAwareScrollView enableOnAndroid enableAutomaticScroll extraScrollHeight={20}>
                                                        ...
                                                        <Center bg="error.400" h="6%" w="90%" mt="5%" ml="5%" rounded="full" >
                                                           <HStack>
                                                                ...
                                                                <View>
                                                                    <Center>
                                                                        <Button
                                                                            ...
                                                                            onPress={this.state.connection_status ? this.disable : this.noInternetConnection}>

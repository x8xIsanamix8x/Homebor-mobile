...
import { NativeBaseProvider, Text, Button, Heading, Spinner,  Stack, Avatar, Slide, Alert as AlertNativeBase, VStack, HStack, Skeleton, Center } from 'native-base';
                                                ...
                                                <View>
                                                    {item.h_name == "NULL"
                                                            ?
                                                                <Text></Text>
                                                            :
                                                                <Text style={globalStyles.h_name}>{this.state.HouseLName}, {this.state.HouseName}</Text>
                                                    }
                                                </View>

...
import { View, ScrollView, RefreshControl, Image, ImageBackground, Dimensions } from 'react-native';
import { NativeBaseProvider, Text, Spinner, Heading, Button, Avatar, Slide, Alert as AlertNativeBase, VStack, HStack, Skeleton, Center } from 'native-base';
				...
				<View style={globalStyles.skeletonMarginTop}>
					<Center w="100%">
						...
						borderColor: "coolGray.200"
							...
							<VStack w="90%" mb="3" borderWidth="1" space={8} overflow="hidden" rounded="md" _dark={{
								borderColor: "coolGray.500"
								}} _light={{
								borderColor: "coolGray.200"
								}}>
							...
							<NativeBaseProvider>
								...
								<ScrollView nestedScrollEnabled={true} >
									...
									<View style={ globalStyles.profileMargins}>
											<Avatar size="lg" bg="#232159" style={globalStyles.profileStudentnot} source={ item.photo_s != "NULL" && { uri: `http://homebor.com/${item.photo_s}` }}>{item.photo_s.toUpperCase().charAt(0)}
											</Avatar>

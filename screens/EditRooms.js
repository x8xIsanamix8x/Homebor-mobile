...
import { NativeBaseProvider, Heading, Spinner, Input, InputLeftAddon, InputGroup, Button, Stack, Slide, Alert as AlertNativeBase, VStack, HStack, Skeleton, Center } from 'native-base';
                                    ...
                                    <View style={ globalStyles.underlinig }/>
                                        <ScrollView horizontal={true} style={ globalStyles.scrollviewedit}>
                                            ...
                                            <View style={globalStyles.inlineTitleEditRoom}>
                                                ...
                                                resizeMode="contain"
                                                style={globalStyles.imageroomEditFoodEdit}
                                                ></Image>
                                                    <Picker
                                            ...
                                            {this.state.type1 != 'NULL' && (
                                                <View style={globalStyles.BedviewEdit1}>
                                                    <View style={globalStyles.BedTitleEdit}>
                                                    ...
                                                    <View style={globalStyles.inlineTitleEditRoom}>
                                                        ...
                                                        resizeMode="contain"
                                                        style={globalStyles.imageroomEditBed3}
                                                        ></Image>
                                                                <Picker
                                                                    style={globalStyles.pickerBed3} 
                                                    ...
                                                    {this.state.type1 == 'Share' && (<View style={globalStyles.BedviewEdit2}>
                                                        {/*Bed 1_2 */}
                                                        <View style={globalStyles.BedTitleEdit}>
                                                        ...
                                                        <View style={globalStyles.CollapseBed3Edit}>
                                                            {this.state.bed1_3 == 'NULL' && this.state.date1_3 == 'NULL' ?
                                                                ...
                                                                <Collapse style={globalStyles.wrapperCollapsibleListEditBed} isExpanded={this.state.expandedbed} onToggle={(isExpanded)=>this.setState({expandedbed: isExpanded})}>
                                                                    ...
                                                                    <CollapseBody>
                                                                            {/*Bed 1_3 */}
                                                                            <View style={globalStyles.BedviewEdit3}>
                                                                                <View style={globalStyles.BedTitleEdit}>
                                                                ...
                                                                :
                                                                <View style={globalStyles.BedviewEdit4}>
                                                                    <View style={globalStyles.BedTitleEdit2}>
                                                                        <Text style={ globalStyles.infotitleEditRoom}>Bed 3</Text>
                                                                    </View>
                                                ...
                                                <ScrollView horizontal={true} style={ globalStyles.scrollviewedit}>
                                                    ...
                                                    <View style={globalStyles.inlineTitleEditRoom}>
                                                        ...
                                                        <View style={globalStyles.BedviewEdit1}>
                                                            ...
                                                            {this.state.type2 == 'Share' && (<View style={globalStyles.BedviewEdit2}>
                                                                {/*Bed 2_2 */}
                                                                <View style={globalStyles.BedTitleEdit}>
                                                                    <Text style={ globalStyles.infotitleEditRoom}>Bed 2</Text>
                                                                </View>
                                                    ...
                                                    <ScrollView horizontal={true} style={ globalStyles.scrollviewedit}>
                                                        ...
                                                        <View style={globalStyles.inlineTitleEditRoom}>
                                                            ...
                                                            <View style={globalStyles.BedviewEdit1}>
                                                                ...
                                                                {this.state.type3 == 'Share' && (<View style={globalStyles.BedviewEdit2}>
                                                                    {/*Bed 3_2 */}
                                                                    <View style={globalStyles.BedTitleEdit}>
                                                                        <Text style={ globalStyles.infotitleEditRoom}>Bed 2</Text>
                                                                    </View>
                                                    ...
                                                    <ScrollView horizontal={true} style={ globalStyles.scrollviewedit}>
                                                        ...
                                                        <View style={globalStyles.inlineTitleEditRoom}>
                                                            ...
                                                            <View style={globalStyles.BedviewEdit1}>
                                                                ...
                                                                {this.state.type4 == 'Share' && (<View style={globalStyles.BedviewEdit2}>
                                                                    {/*Bed 4_2 */}
                                                                    <View style={globalStyles.BedTitleEdit}>
                                                                        <Text style={ globalStyles.infotitleEditRoom}>Bed 2</Text>
                                                                    </View>
                                                ...
                                                <ScrollView horizontal={true} style={ globalStyles.scrollviewedit}>
                                                    ...
                                                    <View style={globalStyles.inlineTitleEditRoom}>
                                                        ...
                                                        <View style={globalStyles.BedviewEdit1}>
                                                            ...
                                                            {this.state.type5 == 'Share' && (<View style={globalStyles.BedviewEdit2}>
                                                                {/*Bed 5_2 */}
                                                                <View style={globalStyles.BedTitleEdit}>
                                                                    <Text style={ globalStyles.infotitleEditRoom}>Bed 2</Text>
                                                                </View>
                                                ...
                                                <ScrollView horizontal={true} style={ globalStyles.scrollviewedit}>
                                                    ...
                                                    <View style={globalStyles.inlineTitleEditRoom}>
                                                        ...
                                                        <View style={globalStyles.BedviewEdit1}>
                                                            ...
                                                            {this.state.type6 == 'Share' && (<View style={globalStyles.BedviewEdit2}>
                                                                {/*Bed 6_2 */}
                                                                <View style={globalStyles.BedTitleEdit}>
                                                                    <Text style={ globalStyles.infotitleEditRoom}>Bed 2</Text>
                                                                </View>
                                                ...
                                                <ScrollView horizontal={true} style={ globalStyles.scrollviewedit}>
                                                    ...
                                                    <View style={globalStyles.inlineTitleEditRoom}>
                                                        ...
                                                        <View style={globalStyles.BedviewEdit1}>
                                                            ...
                                                            {this.state.type7 == 'Share' && (<View style={globalStyles.BedviewEdit2}>
                                                                {/*Bed 7_2 */}
                                                                <View style={globalStyles.BedTitleEdit}>
                                                                    <Text style={ globalStyles.infotitleEditRoom}>Bed 2</Text>
                                                                </View>
                                                ...
                                                <ScrollView horizontal={true} style={ globalStyles.scrollviewedit}>
                                                    ...
                                                    <View style={globalStyles.inlineTitleEditRoom}>
                                                        ...
                                                        <View style={globalStyles.BedviewEdit1}>
                                                            ...
                                                            {this.state.type8 == 'Share' && (<View style={globalStyles.BedviewEdit2}>
                                                                {/*Bed 8_2 */}
                                                                <View style={globalStyles.BedTitleEdit}>
                                                                    <Text style={ globalStyles.infotitleEditRoom}>Bed 2</Text>
                                                                </View>

	...
	return ( 
		<Container style={ globalStyles.contenedor} >
			<ScrollView>
				...
				<View style={ globalStyles.hr} />
				<View>
				<Image source={require('../assets/img/prueba/k.jpg')} style={ globalStyles.image}></Image>
				</View>
				<View>
				<Image source={require('../assets/img/prueba/f.jpg')} style={ globalStyles.image}></Image>
				</View>
				<View>
				<Image source={require('../assets/img/prueba/k.jpg')} style={ globalStyles.image}></Image>
				</View>
				<View>
				<Image source={require('../assets/img/prueba/b.jpg')} style={ globalStyles.image}></Image>
				</View>
				<View>
				<Image source={require('../assets/img/prueba/c.jpg')} style={ globalStyles.image}></Image>
				</View>
				<View>
				<Image source={require('../assets/img/prueba/d.jpg')} style={ globalStyles.image}></Image>
				</View>
				<View>
				<Image source={require('../assets/img/prueba/e.jpg')} style={ globalStyles.image}></Image>
				</View>
				</View>

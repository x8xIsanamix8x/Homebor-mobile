<?php
    ...
    if($photo1 == 'Yes') {
        ...
        if(move_uploaded_file($_FILES['photo']['tmp_name'],$img_path)){
            ...
            $img_pathComplete='https://www.homebor.com/public/'.$email.'/'.$_FILES['photo']['name'];
            $query=$result->prepare($sql);
            $res = $query->execute();
    ...
    if($photo2 == 'Yes') {
        ...
        if(move_uploaded_file($_FILES['photo2']['tmp_name'],$img2_path)){
            ...
            $img2_pathComplete='https://www.homebor.com/public/'.$email.'/'.$_FILES['photo2']['name'];
            $query=$result->prepare($sql);
            $res = $query->execute();
    ...
    if($photo3 == 'Yes') {
        ...
        if(move_uploaded_file($_FILES['photo3']['tmp_name'],$img3_path)){
            ...
            $img3_pathComplete='https://www.homebor.com/public/'.$email.'/'.$_FILES['photo3']['name'];
            $query=$result->prepare($sql);
            $res = $query->execute();
    ...
    if($photo4 == 'Yes') {
        ...
        if(move_uploaded_file($_FILES['photo4']['tmp_name'],$img4_path)){
            ...
            $img4_pathComplete='https://www.homebor.com/public/'.$email.'/'.$_FILES['photo4']['name'];
            $query=$result->prepare($sql);
            $res = $query->execute();
    ...
    if($photo5 == 'Yes') {
        ...
        if(move_uploaded_file($_FILES['photo5']['tmp_name'],$img5_path)){
            ...
            $img5_pathComplete='https://www.homebor.com/public/'.$email.'/'.$_FILES['photo5']['name'];
            $query=$result->prepare($sql);
            $res = $query->execute();
    ...
    if($photo6 == 'Yes') {
        ...
        if(move_uploaded_file($_FILES['photo6']['tmp_name'],$img6_path)){
            ...
            $img6_pathComplete='https://www.homebor.com/public/'.$email.'/'.$_FILES['photo6']['name'];
            $query=$result->prepare($sql);
            $res = $query->execute();
    ...
    if($photo7 == 'Yes') {
        ...
        if(move_uploaded_file($_FILES['photo7']['tmp_name'],$img7_path)){
            ...
            $img7_pathComplete='https://www.homebor.com/public/'.$email.'/'.$_FILES['photo7']['name'];
            $query=$result->prepare($sql);
            $res = $query->execute();
    ...
    if($photo8 == 'Yes') {
        ...
        if(move_uploaded_file($_FILES['photo8']['tmp_name'],$img8_path)){
            ...
            $img8_pathComplete='https://www.homebor.com/public/'.$email.'/'.$_FILES['photo8']['name'];
            $query=$result->prepare($sql);
            $res = $query->execute();
    ...
    if($photo9 == 'Yes') {
        ...
        if(move_uploaded_file($_FILES['photo9']['tmp_name'],$img9_path)){
            ...
            $img9_pathComplete='https://www.homebor.com/public/'.$email.'/'.$_FILES['photo9']['name'];
            $query=$result->prepare($sql);
            $res = $query->execute();
    ...
    if($photo10 == 'Yes') {
        ...
        if(move_uploaded_file($_FILES['photo10']['tmp_name'],$img10_path)){
            ...
            $img10_pathComplete='https://www.homebor.com/public/'.$email.'/'.$_FILES['photo10']['name'];
            $query=$result->prepare($sql);
            $res = $query->execute();
    ...
    if($photo11 == 'Yes') {
        ...
        if(move_uploaded_file($_FILES['photo11']['tmp_name'],$img11_path)){
            ...
            $img11_pathComplete='https://www.homebor.com/public/'.$email.'/'.$_FILES['photo11']['name'];
            $query=$result->prepare($sql);
            $res = $query->execute();

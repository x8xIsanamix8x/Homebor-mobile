...
if($photo1 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo1']['tmp_name'],$img_path)){
       $sql="UPDATE photo_home SET proom1 = '$img_path2' WHERE id_home = '$id'";
        $img2_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo1']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo1_2 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo1_2']['tmp_name'],$img1_2_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo1_2']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo1_3 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo1_3']['tmp_name'],$img1_3_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo1_3']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo2 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo2']['tmp_name'],$img2_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo2']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo2_2 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo2_2']['tmp_name'],$img2_2_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo2_2']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo2_3 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo2_3']['tmp_name'],$img2_3_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo2_3']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo3 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo3']['tmp_name'],$img3_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo3']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo3_2 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo3_2']['tmp_name'],$img3_2_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo3_2']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo3_3 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo3_3']['tmp_name'],$img3_3_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo3_3']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo4 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo4']['tmp_name'],$img4_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo4']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo4_2 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo4_2']['tmp_name'],$img4_2_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo4_2']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo4_3 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo4_3']['tmp_name'],$img4_3_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo4_3']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo5 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo5']['tmp_name'],$img5_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo5']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo5_2 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo5_2']['tmp_name'],$img5_2_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo5_2']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo5_3 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo5_3']['tmp_name'],$img5_3_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo5_3']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo6 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo6']['tmp_name'],$img6_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo6']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo6_2 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo6_2']['tmp_name'],$img6_2_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo6_2']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo6_3 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo6_3']['tmp_name'],$img6_3_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo6_3']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo7 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo7']['tmp_name'],$img7_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo7']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo7_2 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo7_2']['tmp_name'],$img7_2_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo7_2']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo7_3 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo7_3']['tmp_name'],$img7_3_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo7_3']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo8 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo8']['tmp_name'],$img8_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo8']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo8_2 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo8_2']['tmp_name'],$img8_2_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo8_2']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
...
if($photo8_3 == 'Yes') {
    ...
    if(move_uploaded_file($_FILES['photo8_3']['tmp_name'],$img8_3_path)){
        ...
        $img_pathComplete='http://homebor.com/public/'.$email.'/'.$_FILES['photo8_3']['name'];
        $query=$result->prepare($sql);
        $res = $query->execute();
